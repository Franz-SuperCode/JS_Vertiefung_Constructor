...
class Pokemon {
    ...
    writeHTML() {
        ...
        liEl.textContent = `Name: ${this.name} Gewicht: ${this.weight} Fangdatum: ${this.catchDate} Attacken: ${this.attacks}`,
            liEl.innerHTML += `<img src="https://images.unsplash.com/photo-1542779283-429940ce8336?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="">`
        console.log(liEl);
        //In <ul> einfügen
